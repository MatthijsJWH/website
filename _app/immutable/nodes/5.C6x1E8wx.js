import{b as V,d as ye,c as X,h as we,a as g,t as b,s as v}from"../chunks/Bkbb3s7N.js";import"../chunks/ntXFN0NU.js";import{a2 as D,h as Z,e as ee,J as _e,ad as ke,o as te,W as xe,ae as Se,af as je,i as He,C as P,a0 as De,a1 as L,a3 as Ie,s as O,m as U,g as e,D as ae,a4 as se,a6 as s,a7 as t,a5 as i,a8 as oe}from"../chunks/qHbpwGOs.js";import{i as W}from"../chunks/Cjq_siLI.js";import{e as ne,i as ie}from"../chunks/8pFU8GZI.js";import{s as z}from"../chunks/bubRgeq0.js";import{i as Te}from"../chunks/BFBkySXB.js";import{s as Ke,a as Pe}from"../chunks/BtDuIBau.js";import{s as Ce}from"../chunks/Dl0e-w9S.js";import{o as Me}from"../chunks/Xqrvhz9G.js";function $e(l,I,y=!1,w=!1,E=!1){var f=l,a="";D(()=>{var d=_e;if(a===(a=I()??"")){Z&&ee();return}if(d.nodes_start!==null&&(ke(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),a!==""){if(Z){te.data;for(var o=ee(),_=o;o!==null&&(o.nodeType!==8||o.data!=="");)_=o,o=xe(o);if(o===null)throw Se(),je;V(te,_),f=He(o);return}var u=a+"";y?u=`<svg>${u}</svg>`:w&&(u=`<math>${u}</math>`);var p=ye(u);if((y||w)&&(p=P(p)),V(P(p),p.lastChild),y||w)for(;P(p);)f.before(P(p));else f.before(p)}})}const Ae=()=>{const l=Ce;return{page:{subscribe:l.page.subscribe},navigating:{subscribe:l.navigating.subscribe},updated:l.updated}},Be={subscribe(l){return Ae().page.subscribe(l)}};var Re=b('<meta name="description">'),Fe=b('<span class="tag svelte-xdppug"> </span>'),qe=b('<div class="related-card svelte-xdppug"><div class="related-category svelte-xdppug"> </div> <h3><a> </a></h3> <p> </p> <a class="read-more svelte-xdppug">Read More →</a></div>'),Le=b('<section class="related-posts svelte-xdppug"><h2>Related Posts</h2> <div class="related-grid svelte-xdppug"></div></section>'),Oe=b('<article class="blog-post svelte-xdppug"><header class="post-header svelte-xdppug"><div class="post-meta svelte-xdppug"><span class="post-category svelte-xdppug"> </span> <span class="post-date svelte-xdppug"> </span></div> <h1 class="svelte-xdppug"> </h1> <div class="post-author svelte-xdppug"><div class="author-avatar svelte-xdppug">MH</div> <div class="author-info"><span class="author-name svelte-xdppug"> </span></div></div></header> <div class="post-content svelte-xdppug"><!></div> <footer class="post-footer svelte-xdppug"><div class="post-tags svelte-xdppug"></div> <div class="post-share svelte-xdppug"><span>Share this post:</span> <div class="share-buttons svelte-xdppug"><button class="share-btn svelte-xdppug" aria-label="Share on Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg></button> <button class="share-btn svelte-xdppug" aria-label="Share on Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></button> <button class="share-btn svelte-xdppug" aria-label="Share on LinkedIn"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></button></div></div></footer></article> <!> <div class="post-navigation svelte-xdppug"><a href="/blog" class="back-to-blog svelte-xdppug">← Back to Blog</a></div>',1),Ue=b(`<div class="post-not-found svelte-xdppug"><h1>Post Not Found</h1> <p>Sorry, the blog post you're looking for doesn't exist or has been removed.</p> <a href="/blog" class="btn">Back to Blog</a></div>`);function Ze(l,I){De(I,!1);const[y,w]=Ke(),E=()=>Pe(Be,"$page",y),f=[{id:1,title:"Getting Started with SvelteKit",content:`
...
&lt;div&gt;{@html post.content}&lt;/div&gt;</code>
      ...
      `,date:"2025-05-01",category:"Web Development",author:"Matthijs Halvemaan",tags:["SvelteKit","JavaScript","Web Development","Frontend"]},{id:2,title:"The Art of Handball: Strategy and Teamwork",content:`
      ...
      `,date:"2025-04-15",category:"Handball",author:"Matthijs Halvemaan",tags:["Handball","Sports","Teamwork","Strategy"]}];let a=U(),d=U([]),o=U("");Me(()=>{const r=parseInt(E().params.id);if(O(a,f.find(n=>n.id===r)),e(a)){const n={year:"numeric",month:"long",day:"numeric"};O(o,new Date(e(a).date).toLocaleDateString("en-US",n)),O(d,f.filter(h=>h.category===e(a).category&&h.id!==e(a).id).slice(0,2))}}),Te();var _=X();we(r=>{var n=X(),h=L(n);{var k=c=>{var T=Re();D(K=>{se.title=`${e(a).title??""} | Matthijs Halvemaan's Blog`,z(T,"content",K)},[()=>e(a).content.substring(0,160).replace(/<[^>]*>/g,"")],ae),g(c,T)},x=c=>{se.title="Blog Post | Matthijs Halvemaan"};W(h,c=>{e(a)?c(k):c(x,!1)})}g(r,n)});var u=L(_);{var p=r=>{var n=Oe(),h=L(n),k=s(h),x=s(k),c=s(x),T=s(c,!0);t(c);var K=i(c,2),le=s(K,!0);t(K),t(x);var C=i(x,2),de=s(C,!0);t(C);var G=i(C,2),J=i(s(G),2),N=s(J),pe=s(N,!0);t(N),t(J),t(G),t(k);var M=i(k,2),ce=s(M);$e(ce,()=>e(a).content),t(M);var Y=i(M,2),Q=s(Y);ne(Q,5,()=>e(a).tags,ie,(S,j)=>{var m=Fe(),$=s(m);t(m),D(()=>v($,`#${e(j)??""}`)),g(S,m)}),t(Q),oe(2),t(Y),t(h);var he=i(h,2);{var ge=S=>{var j=Le(),m=i(s(j),2);ne(m,5,()=>e(d),ie,($,H)=>{var A=qe(),B=s(A),ve=s(B,!0);t(B);var R=i(B,2),F=s(R),ue=s(F,!0);t(F),t(R);var q=i(R,2),fe=s(q);t(q);var me=i(q,2);t(A),D(be=>{v(ve,e(H).category),z(F,"href",`/blog/${e(H).id}`),v(ue,e(H).title),v(fe,`${be??""}...`),z(me,"href",`/blog/${e(H).id}`)},[()=>e(H).content.substring(0,120).replace(/<[^>]*>/g,"")],ae),g($,A)}),t(m),t(j),g(S,j)};W(he,S=>{e(d).length>0&&S(ge)})}oe(2),D(()=>{v(T,e(a).category),v(le,e(o)),v(de,e(a).title),v(pe,e(a).author)}),g(r,n)},re=r=>{var n=Ue();g(r,n)};W(u,r=>{e(a)?r(p):r(re,!1)})}g(l,_),Ie(),w()}export{Ze as component};
