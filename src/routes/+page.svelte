...
<svelte:head>
  <title>Matthijs Halvemaan | Full Stack Developer</title>
  <meta name="description" content="Personal website of Matthijs Halvemaan, a full stack software developer, handball enthusiast, and all-around geek." />
</svelte:head>
